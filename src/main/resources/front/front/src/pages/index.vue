<template>
  <div class="main-containers">
    <div class="top-container"
         :style='{"padding":"0 20px","overflow":"hidden","top":"0","alignItems":"center","left":"0","background":"#FFFAFA","display":"flex","width":"100%","position":"fixed","justifyContent":"space-between","height":"55px","zIndex":"1002"}'>
      <img v-if='true' :style='{"width":"0px","objectFit":"cover","borderRadius":"100%","display":"block","height":"0px","float":"right"}'
           src='http://codegen.caihongy.cn/20201114/7856ba26477849ea828f481fa2773a95.jpg'>
      <div v-if="true" :style='{"color":"#000","fontSize":"30px","fontWeight":"600","font-family":"STKaiti"}'>基于协同过滤算法的个性化电影推荐网站</div>
      <div>
    ...
    <div class="body-containers"
         :style='"horizontal" == "vertical" ? {"minHeight":"100vh","padding":"64px 0 0","margin":"0 0 0 210px","position":"relative","background":"rgba(64, 158, 255, .3)","display":"block"} : {"minHeight":"100vh","padding":"55px 0 0","margin":"0","position":"relative"}'>
      <div class="menu-preview"
           :style='{"width":"100%","padding":"0 20px","borderStyle":"solid","background":"rgba(216, 216, 216, 1)","borderWidth":"0","height":"auto"}'>
        <el-menu class="el-menu-horizontal-demo"
                 :style='{"border":0,"padding":"20px 0","listStyle":"none","margin":"0","background":"rgba(216, 216, 216, 1)","display":"flex","position":"relative","justifyContent":"center","height":"100px"}'
          ...
          <el-menu-item v-for="(menu, index) in menuList" :index="index + ''" :key="index" :route="menu.url">
            ...
            <span :style='{"padding":"0 10px","lineHeight":"60px","fontSize":"14px","color":"inherit","height":"60px"}'>{{
                menu.name
              }}</span>
          </el-menu-item>
      ...
      <div class="banner-preview" :style='{"width":"100%","height":"auto"}'>
        <el-carousel :style='{"width":"100%","margin":"0 auto"}' trigger="click" indicator-position="inside"
          ...
          <el-carousel-item :style='{"borderRadius":"10px","width":"100%","height":"100%"}' v-for="item in carouselList"
                            :key="item.id">
