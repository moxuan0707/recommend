...
<div>
	...
	<div class="detail-preview" :style='{"width":"1100px","margin":"10px auto","position":"relative"}'>
		<div class="attr" :style='{"minHeight":"650px","padding":"20px 20px 50px","position":"relative","flexDirection":"row-reverse","display":"flex"}'>
			...
			<div class="zancai" :style='{"padding":"0","margin":"0","top":"630px","display":"flex","width":"300px","position":"absolute","right":"80px","height":"50px"}'>
				<div :style='{"padding":"10px 0","margin":"0 20px","alignItems":"center","background":"#fff","display":"flex","width":"auto","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="zan" @click="thumbsupOrCrazily(21)">
				...
				<div :style='{"padding":"10px 0","margin":"0 20px","alignItems":"center","background":"#fff","display":"flex","width":"auto","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="cai" @click="thumbsupOrCrazily(22)">
				...
				<div :style='{"padding":"10px 0","margin":"0 20px","alignItems":"center","background":"#fff","display":"flex","width":"auto","justifyContent":"center"}' v-if="isThumbsupnum" class="zan" @click="cancelThumbsupOrCrazily(21)">
					<i :style='{"color":"#666","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-dianzan"></i>
					<span :style='{"color":"#666","margin":"0 3px","fontSize":"14px"}'>取消赞({{detail.thumbsupnum}})</span>
				</div>
				<div :style='{"padding":"10px 0","margin":"0 20px","alignItems":"center","background":"#fff","display":"flex","width":"auto","justifyContent":"center"}' v-if="isCrazilynum" class="cai" @click="cancelThumbsupOrCrazily(22)">
					<i :style='{"color":"#666","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-iconfontzan"></i>
			...
			<div class="info" :style='{"width":"600px","padding":"10px","margin":"0 20px 0 0","borderRadius":"10px","background":"rgba(245, 245, 245, 1)"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"122px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>电影类型</div>
					<div  :style='{"padding":"0 10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","color":"#666","width":"60%","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.dianyingleixing}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"122px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>上映年份</div>
					<div  :style='{"padding":"0 10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","color":"#666","width":"60%","fontSize":"14px","lineHeight":"40px","height":"40px","display":"block","overflow":"hidden","word-break":"keep-all","white-space":"nowrap","text-overflow":"ellipsis"}'>{{detail.shangyingnianfen}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"122px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>上映日期</div>
					<div  :style='{"padding":"0 10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","color":"#666","width":"60%","fontSize":"14px","lineHeight":"40px","height":"40px","display":"block","overflow":"hidden","word-break":"keep-all","white-space":"nowrap","text-overflow":"ellipsis"}'>{{detail.shangyingriqi}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"122px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>电影时长</div>
					<div  :style='{"padding":"0 10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","color":"#666","width":"60%","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.dianyingshizhang}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"122px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>电影主演</div>
					<div  :style='{"padding":"0 10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","color":"#666","width":"60%","fontSize":"14px","lineHeight":"40px","height":"40px","display":"block","overflow":"hidden","word-break":"keep-all","white-space":"nowrap","text-overflow":"ellipsis"}'>{{detail.dianyingzhuyan}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"122px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>电影导演</div>
					<div  :style='{"padding":"0 10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","color":"#666","width":"60%","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.dianyingdaoyan}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","width":"122px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>上映地区</div>
					<div  :style='{"padding":"0 10px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","color":"#666","width":"60%","fontSize":"14px","lineHeight":"40px","height":"40px"}'>{{detail.shangyingdiqu}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 50px","outline":"none","color":"#fff","borderRadius":"4px","background":"rgba(67, 144, 165, 1)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('dianyingxinxi','评分')" @click="onAcross('dianyingpingfen','','','')" type="warning">评分</el-button>
				</div>
			</div>
			
		</div>
		
		<video :style='{"border":"0","margin":"10px auto","outline":"none","borderRadius":"4px","display":"block","width":"90%","height":"600px"}' :src="baseUrl +  detail.dianyingpianduan" controls="controls">
			您的浏览器不支持视频播放
		</video>
