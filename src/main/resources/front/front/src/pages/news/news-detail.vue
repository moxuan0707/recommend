<template>
  <div :style='{"padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","margin":"20px auto 30px","borderRadius":"20px","background":"#fff","width":"1100px","position":"relative"}'>
    <div class="section-title" :style='{"margin":"10px 0","borderColor":"rgba(67, 144, 165, 1)","color":"#333","borderRadius":"20px","textAlign":"center","background":"#ffff","borderWidth":"5px 0","fontSize":"20px","lineHeight":"54px","borderStyle":"solid"}'>公告信息</div>
