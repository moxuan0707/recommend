...
import center from '@/views/center'
    ...
    import dianyingtuijian from '@/views/modules/dianyingtuijian/list'
    import config from '@/views/modules/config/list'
    import discussdianyingtuijian from '@/views/modules/discussdianyingtuijian/list'
...
const routes = [{
	...
	path: '/config',
      ...
      ,{
	path: '/discussdianyingtuijian',
        name: '电影推荐评论',
        component: discussdianyingtuijian
      }
    ]
  },
  {
