  ...
  <div>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}'   v-if="flag=='yonghu'"  label="手机" prop="shouji">
        ...
        <el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}'   v-if="flag=='yonghu'"  label="身份证" prop="shenfenzheng">
