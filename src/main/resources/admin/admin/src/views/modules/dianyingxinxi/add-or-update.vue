	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="select" v-if="type!='info'"  label="电影类型" prop="dianyingleixing">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="上映年份" prop="shangyingnianfen">
					<el-input v-model="ruleForm.shangyingnianfen" placeholder="上映年份" clearable  :readonly="ro.shangyingnianfen"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="上映年份" prop="shangyingnianfen">
					<el-input v-model="ruleForm.shangyingnianfen" placeholder="上映年份" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="date" v-if="type!='info'" label="上映日期" prop="shangyingriqi">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.shangyingriqi" label="上映日期" prop="shangyingriqi">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="电影时长" prop="dianyingshizhang">
					<el-input v-model="ruleForm.dianyingshizhang" placeholder="电影时长" clearable  :readonly="ro.dianyingshizhang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="电影时长" prop="dianyingshizhang">
					<el-input v-model="ruleForm.dianyingshizhang" placeholder="电影时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="电影主演" prop="dianyingzhuyan">
					<el-input v-model="ruleForm.dianyingzhuyan" placeholder="电影主演" clearable  :readonly="ro.dianyingzhuyan"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="电影主演" prop="dianyingzhuyan">
					<el-input v-model="ruleForm.dianyingzhuyan" placeholder="电影主演" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="电影导演" prop="dianyingdaoyan">
					<el-input v-model="ruleForm.dianyingdaoyan" placeholder="电影导演" clearable  :readonly="ro.dianyingdaoyan"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="电影导演" prop="dianyingdaoyan">
					<el-input v-model="ruleForm.dianyingdaoyan" placeholder="电影导演" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="上映地区" prop="shangyingdiqu">
					<el-input v-model="ruleForm.shangyingdiqu" placeholder="上映地区" clearable  :readonly="ro.shangyingdiqu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else class="input" label="上映地区" prop="shangyingdiqu">
					<el-input v-model="ruleForm.shangyingdiqu" placeholder="上映地区" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-if="type!='info'"  label="电影详情" prop="dianyingxiangqing">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","float":"left","justifyContent":"flex-start"}' v-else-if="ruleForm.dianyingxiangqing" label="电影详情" prop="dianyingxiangqing">
...
export default {
	...
	this.ruleForm.dianyingxiangqing = this.ruleForm.dianyingxiangqing.replace(reg,'../../../springbootl07f8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
