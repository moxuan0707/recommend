		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"100%","margin":"16px 0 20px","flexWrap":"wrap","display":"flex"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"width":"100%","padding":"0","margin":"20px 0 20px","background":"none","display":"flex"}'>
					<el-button :style='{"border":"1px solid #c1ccf4","cursor":"pointer","padding":"0 24px","boxShadow":"0 2px 6px rgba(0,0,0,.6)","margin":"0 10px 0 0","outline":"none","color":"#c1ccf4","borderRadius":"20px","background":"rgba(243,234,250,.2)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('discussdianyingxinxi','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"1px solid #d67081","cursor":"pointer","padding":"0 24px","boxShadow":"0 2px 6px rgba(0,0,0,.6)","margin":"0 10px 0 0","outline":"none","color":"#df2543","borderRadius":"20px","background":"rgba(223,37,67,.2)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('discussdianyingxinxi','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"1px solid #22d6c3","cursor":"pointer","padding":"0 16px","margin":"3px 6px 3px 0","outline":"none","color":"#22d6c3","borderRadius":"20px","background":"rgba(31,191,174,.1)","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('discussdianyingxinxi','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>


							<el-button :style='{"border":"1px solid #c1ccf4","cursor":"pointer","padding":"0 16px","margin":"3px 6px 3px 0","outline":"none","color":"#c1ccf4","borderRadius":"20px","background":"rgba(193,204,244,.1)","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('discussdianyingxinxi','查看评论')" type="primary" size="mini" @click="disscussListHandler(scope.row.id)">查看评论</el-button>
